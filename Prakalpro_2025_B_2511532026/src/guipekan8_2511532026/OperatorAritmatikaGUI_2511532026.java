...
public class OperatorAritmatikaGUI_2511532026 extends JFrame {
...
//	private pesanPeringatan;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OperatorAritmatikaGUI_2511532026 frame = new OperatorAritmatikaGUI_2511532026();
	 ...
	 * Create the frame.
	 */
	public OperatorAritmatikaGUI_2511532026() {
